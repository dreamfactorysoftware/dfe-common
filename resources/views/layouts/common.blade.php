...
<head>
    {{-- @formatter:off --}}
    @section('page-theme'){{ config('dfe.common.themes.page', 'flatly') }}@stop
    {{-- @formatter:on --}}
    ...
    <link href="/vendor/dfe-common/static/bootswatch-3.3.4/@yield('page-theme').min.css" rel="stylesheet">
    <link href="/static/font-awesome-4.3.0/css/font-awesome.min.css" rel="stylesheet">
    <link href="/css/style.css" rel="stylesheet">
    <link href="/vendor/dfe-common/css/auth.{{ config('dfe.common.themes.auth', 'darkly') }}.css" rel="stylesheet">
    <!--[if lt IE 9]>
